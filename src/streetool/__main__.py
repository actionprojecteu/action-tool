...
def createParser():
	...
	group = classif.add_mutually_exclusive_group()
	group.add_argument('--anon-user', action='store_true', help='Show classifications per anonymous user.')
	group.add_argument('--user', action='store_true', help='Show classifications per registered user.')
	...
	soplot.add_argument('--distance',    type=float, default=25, help='Cluster max distance between points')
